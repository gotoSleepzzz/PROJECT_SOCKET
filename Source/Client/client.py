...
class Login(Toplevel):
    ...
    def on_closing(self):
        ...
        self.destroy()
        self.master.deiconify()
        self.master.client_connect.close()
        self.master.client_connect = None
        self.master.client_connect = socket.socket(socket.AF_INET,socket.SOCK_STREAM)
        pass
